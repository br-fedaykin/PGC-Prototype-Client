...
web3j solidity generate -a=bin/src/main/resources/solidity/smartDCPABERequests.abi -b=bin/src/main/resources/solidity/smartDCPABERequests.bin -o=src/main/java -p=com.brunoarruda.hyperdcpabe.blockchain
